...
public class MerchantPayment extends Activity {
    ...
    EditText edtMerchantMobileNumber,edtMerchantAmount,edtMerchantAlternateMobileNumber,edtMerchantRemarks,edtMpin,edtMerchantAlternateName;TextView edtMerchantAlternateMobileNumber1;
    ...
    private String merchantNumber="",amount="",Isd_code="+91",merchantName;
...
//        edtMerchantAlternateName = (EditText)findViewById(R.id.edtMerchantAlternateName);
        ...
        edtMerchantAlternateMobileNumber1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<PhoneNumberVerifier.Countries> adapter = new ArrayAdapter<PhoneNumberVerifier.Countries>(MerchantPayment.this, android.R.layout.simple_dropdown_item_1line, PhoneNumberVerifier.Countries.values());
        ...
        idfavimg.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            Intent i = new Intent(MerchantPayment.this, FavoriteActivity.class);
                                            startActivity(i);
                                        }
                                    }
        );
        ...
        dotimg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(MerchantPayment.this, dotimg);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        Intent i = new Intent(MerchantPayment.this, WebActivity.class);
...
//            startActivityForResult(i, PICK_FROM_GALLERY);
    ...
    {
        AlertBuilder alert = new AlertBuilder(MerchantPayment.this);
        if(userInfoPref.getBoolean("new_user_registered_newapp",false)) {
...
//                String remarks = Uri.encode(merchantName, "utf-8");
                String alternateNo = "";
//                String alternateName = Uri.encode(edtMerchantAlternateName.getText().toString(),"utf-8");
...
//                }
                else if(edtMpin.getText().toString().trim().equalsIgnoreCase(""))
                {
                    ...
                    String Provider="";
                    String BingoString = mdn.trim() + "|" + mpin.trim()+"|"+payeeMobile.trim()+"|"+ Provider.trim()+"|"+Amount.trim();
                    String res = Bingo.Bingo_one(BingoString);
                    String merchantPaymentUrl = getResources().getString(R.string.merchantPayment) + "?mobileNo=" + mdn + "&payeeMobileNo=" + payeeMobile +
                            "&Amount=" + Amount + "&Remark=" + remarks + "&alterMobileNo=" +alternateNo+ "&nickName="+alternateName+"&MPIN=" + mpin+"&Checksum="+res;

                    CheckBalance checkBalance = new CheckBalance(MerchantPayment.this);
                    if(checkBalance.getBalanceCheck(Amount)) {

                        PopupBuilder popup = new PopupBuilder(MerchantPayment.this);
                        popup.showPopup(checkBalance.getAmount(Amount));

                        userInfoEditor.putString("transaction_url", merchantPaymentUrl);
                        ...
                        URL = getResources().getString(R.string.merchantPayment) + "?mobileNo=" + mdn + "&payeeMobileNo=" + payeeMobile + "&Amount=" + Amount + "&Remark=" + remarks + "&alterMobileNo=" +alternateNo+ "&nickName="+alternateName;


                        MerchantPaymentAsync merchantPaymentAsync = new MerchantPaymentAsync(getApplicationContext());
                        merchantPaymentAsync.execute(merchantPaymentUrl);
                    }
                }
            }
            else
    ...
    {
        Intent i = new Intent(MerchantPayment.this, Shopping.class);
        startActivity(i);
    }
    public void openhome(View v)
    {
        Intent i = new Intent(MerchantPayment.this, HomeScreenActivity.class);
        startActivity(i);
    }
    ...
    {
        Intent i = new Intent(MerchantPayment.this, MyAcount.class);
        startActivity(i);
    }
    @Override
...
//                edtMerchantAlternateName.setText("");
    ...
    private void retrieveAlternateContactNumber() {
        ...
        try
        {
            ...
            Contact contact = new Contact(MerchantPayment.this,edtMerchantAlternateMobileNumber,Isd_code,count);
...
//            }
    ...
    private void retrieveContactNumber() {
        ...
        try
        {
            ...
            Contact contact = new Contact(MerchantPayment.this,edtMerchantMobileNumber);
            contact.getContactNumber(id);
...
//            }
    ...
    private class MerchantPaymentAsync extends AsyncTask<String, Void, String> {
        ...
        public MerchantPaymentAsync(Context context) {
            this.context = context;
        }
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MerchantPayment.this);
                ...
                if (jsonStr != null) {
                    try {
                        ...
                        if (jsonMainObj.getString("responseStatus").equalsIgnoreCase("SUCCESS")) {
                            ...
                            {
                                new LocalNotification(MerchantPayment.this,jsonMainObj.getString(getApplicationContext().getResources().getString(R.string.notificationTitle)),jsonMainObj.getString(getApplicationContext().getResources().getString(R.string.notificationMessage))).sendNotification();
                            }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Success")) {
                ...
                if(chkFavMerchant.isChecked())
                {
                    ...
                    AddFavorites addFavorites = new AddFavorites(MerchantPayment.this);
    ...
    private class AddFavorites extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                WebServiceHandler serviceHandler = new WebServiceHandler(MerchantPayment.this, se);
