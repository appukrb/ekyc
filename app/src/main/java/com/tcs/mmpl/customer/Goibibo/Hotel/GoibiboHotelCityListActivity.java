...
public class GoibiboHotelCityListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goibibo_hotel_city_list);

        url = getResources().getString(R.string.hotel_city_list_url);
    ...
    private class GetCity extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(GoibiboHotelCityListActivity.this);
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                WebServiceHandler serviceHandler = new WebServiceHandler(GoibiboHotelCityListActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Success")) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(
                        GoibiboHotelCityListActivity.this).create();
