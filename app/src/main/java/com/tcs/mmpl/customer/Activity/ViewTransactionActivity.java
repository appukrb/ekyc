...
public class ViewTransactionActivity extends ListFragment {
    ...
    public void setMenuVisibility(final boolean visible) {
        ...
        if (visible) {
            try {
                String transurl = getActivity().getResources().getString(R.string.account_statement) + "?MDN=" + pref.getString("mobile_number", "");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_view_transaction, container, false);
