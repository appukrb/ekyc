...
public class SkillAngelsPayment extends Activity {
    ...
    private String merchantNumber="",amount="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skill_angels_payment);
        ...
        idfavimg.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            Intent i = new Intent(SkillAngelsPayment.this, FavoriteActivity.class);
                                            startActivity(i);
                                        }
                                    }
        );
        ...
        dotimg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(SkillAngelsPayment.this, dotimg);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        Intent i = new Intent(SkillAngelsPayment.this, WebActivity.class);
...
//        }
    ...
    public void SkillAngelsPayment(View v)
    {
        AlertBuilder alert = new AlertBuilder(SkillAngelsPayment.this);
        if(userInfoPref.getBoolean("new_user_registered_newapp",false)) {
            if(connectionDetector.isConnectingToInternet())
            {
                ...
                else if ( payeeMobile.trim().equalsIgnoreCase("") || mpin.trim().equalsIgnoreCase("") || Amount.trim().equalsIgnoreCase("") ||  alternateName.trim().equalsIgnoreCase("") ||  alternateNo.trim().equalsIgnoreCase("")) {

                    alert.showAlert(getResources().getString(R.string.validation));

                } else {
                    String SkillAngelsPaymentUrl = getResources().getString(R.string.merchantPayment) + "?mobileNo=" + mdn + "&payeeMobileNo=" + payeeMobile + "&Amount=" + Amount + "&Remark=" + remarks + "&alterMobileNo=" +alternateNo+ "&nickName="+alternateName+"&MPIN=" + mpin;

                    CheckBalance checkBalance = new CheckBalance(SkillAngelsPayment.this);
                    if(checkBalance.getBalanceCheck(Amount)) {

                        PopupBuilder popup = new PopupBuilder(SkillAngelsPayment.this);
                        popup.showPopup(checkBalance.getAmount(Amount));

                        userInfoEditor.putString("transaction_url", SkillAngelsPaymentUrl);
                        ...
                        SkillAngelsPaymentAsync SkillAngelsPaymentAsync = new SkillAngelsPaymentAsync(getApplicationContext());
                        SkillAngelsPaymentAsync.execute(SkillAngelsPaymentUrl);
                    }
                }
            }
            else
    ...
    {
        Intent i = new Intent(SkillAngelsPayment.this, Shopping.class);
        startActivity(i);
    }
    ...
    private void retrieveAlternateContactNumber() {
        ...
        try
        {
            ...
            Contact contact = new Contact(SkillAngelsPayment.this,edtMerchantAlternateMobileNumber);
...
//            }
    ...
    private void retrieveContactNumber() {
        ...
        try
        {
            ...
            Contact contact = new Contact(SkillAngelsPayment.this,edtMerchantMobileNumber);
            contact.getContactNumber(id);
...
//            }
    ...
    private class SkillAngelsPaymentAsync extends AsyncTask<String, Void, String> {
        ...
        public SkillAngelsPaymentAsync(Context context) {
            this.context = context;
        }
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SkillAngelsPayment.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Success")) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(SkillAngelsPayment.this);
