...
//                popularBrand.execute(getActivity().getResources().getString(R.string.all_brand_url));
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_all_brand, container, false);
