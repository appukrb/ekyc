...
public class BusSeatMapFragment extends Fragment {
    ...
    public static BusSeatMapFragment newInstance(ArrayList<BusSeatMapDetails> result) {
        BusSeatMapFragment busSeatMapFragment = new BusSeatMapFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable("result", result);
        busSeatMapFragment.setArguments(bundle);
        return busSeatMapFragment;
    }
