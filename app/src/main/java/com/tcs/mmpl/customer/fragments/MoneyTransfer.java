...
public class MoneyTransfer extends Fragment
{
    ...
    private ViewFlipper viewFlipper_moneyTransfer;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.flipperlayout_money_transfer,
                container, false);
 ...
 */
    private void init(View rootView) {
        ...
        viewFlipper_moneyTransfer = (ViewFlipper) rootView.findViewById(R.id.viewflipper_moneyTransfer);
